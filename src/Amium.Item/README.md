...
`Amium.Item` provides a lightweight hierarchical item model with named parameters, child items, JSON serialization helpers, cloning helpers, and path normalization utilities.
