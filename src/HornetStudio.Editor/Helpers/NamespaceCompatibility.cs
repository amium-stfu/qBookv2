...
namespace HornetStudio.EditorUi.Converters
{
    public sealed class BoolToBrushConverter : IValueConverter
    {
        private readonly HornetStudio.Editor.Converters.BoolToBrushConverter _impl = new();
    ...
    {
        private readonly HornetStudio.Editor.Converters.BoolNegationConverter _impl = new();
...
namespace HornetStudio.EditorUi
{
...
namespace HornetStudio.EditorUi.Helpers
{
    internal static class SvgIconCache
    {
        public static string? ResolvePath(string? iconPath, string? tintColor)
            => HornetStudio.Editor.Helpers.SvgIconCache.ResolvePath(iconPath, tintColor);
    }
}
