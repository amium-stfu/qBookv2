...
Rule:
Whenever the helper API changes, this file and the copied runtime doc in `src/AutomationExplorer.Editor/Templates/ui_python_client/COMMANDS.md` must be updated in the same change.
