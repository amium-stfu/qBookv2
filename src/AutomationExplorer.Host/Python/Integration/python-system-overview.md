...
Rule:
Whenever the Python bridge, template workflow, interaction argument shape, or generated support files change, update this file and the copied runtime doc in `src/AutomationExplorer.Editor/Templates/PYTHON_SYSTEM.md` in the same change.
...
- `src/AutomationExplorer.Host/Python/Client/`: host-side runtime bridge for Python clients.
- `src/AutomationExplorer.Host/Python/Integration/`: source-of-truth docs for the Python bridge.
- `src/AutomationExplorer.Editor/Templates/`: starter templates copied for widgets and Python applications.
- `src/AutomationExplorer.Editor/Templates/amium_host/`: bundled host-value access package copied with generated scripts.
- `src/AutomationExplorer.Editor/Templates/ui_python_client/`: bundled helper package copied with generated scripts.
- `src/AutomationExplorer.Editor/Widgets/ApplicationExplorer/`: editor/runtime UI for Python applications, surfaced in the UI as `ApplicationExplorer`.
...
- If the public helper API changes, also update:
  - `src/AutomationExplorer.Host/Python/Integration/ui-python-client-commands.md`
  - `src/AutomationExplorer.Editor/Templates/ui_python_client/COMMANDS.md`
- If the system behavior or generated folder structure changes, also update:
  - `src/AutomationExplorer.Host/Python/Integration/python-system-overview.md`
  - `src/AutomationExplorer.Editor/Templates/PYTHON_SYSTEM.md`