...
- Location: `src/AutomationExplorer/docs/widgets/help/`
...
- Example lookup for a help window: `src/AutomationExplorer/docs/widgets/help/<Type>.help.md`
...
- `SummaryPath`: `src/AutomationExplorer/docs/widgets/<Type>.md`
- `HelpPath`: `src/AutomationExplorer/docs/widgets/help/<Type>.help.md`
