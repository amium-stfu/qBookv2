...
- Summary file: `src/AutomationExplorer/docs/widgets/LogControl.md`
- Help file: `src/AutomationExplorer/docs/widgets/help/LogControl.help.md`

## Source

- `src/AutomationExplorer.Editor/Widgets/Log/EditorLogControl.axaml.cs`
- `src/AutomationExplorer.Editor/Widgets/Log/EditorProcessLogControl.axaml.cs`