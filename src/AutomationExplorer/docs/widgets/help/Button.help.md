...
- Summary file: `src/AutomationExplorer/docs/widgets/Button.md`
- Help file: `src/AutomationExplorer/docs/widgets/help/Button.help.md`

## Source

- `src/AutomationExplorer.Editor/Widgets/Button/EditorButtonControl.axaml.cs`
