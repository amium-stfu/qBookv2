...
- Summary file: `src/AutomationExplorer/docs/widgets/ApplicationExplorer.md`
- Help file: `src/AutomationExplorer/docs/widgets/help/ApplicationExplorer.help.md`

## Source

- `src/AutomationExplorer.Editor/Widgets/ApplicationExplorer/ApplicationExplorerControl.axaml.cs`