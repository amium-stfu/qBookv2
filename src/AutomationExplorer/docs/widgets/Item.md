...
- `src/AutomationExplorer.Editor/Widgets/Parameter/`
- `src/AutomationExplorer.Editor/Widgets/ValueInput/`

## Help

- Detailed help: `src/AutomationExplorer/docs/widgets/help/Item.help.md`