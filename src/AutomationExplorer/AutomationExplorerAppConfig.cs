...
public sealed class AutomationExplorerAppConfig
{
    public string? StartLayout { get; set; }
    public string? DefaultTheme { get; set; }

    public static AutomationExplorerAppConfig Load(string path)
    {
        try
        {
            if (!File.Exists(path))
            {
                return new AutomationExplorerAppConfig();
            }

            var config = new AutomationExplorerAppConfig();
    ...
    public void Save(string path)
    {
        try
        {
            ...
            writer.WriteLine("# AutomationExplorer application configuration");
