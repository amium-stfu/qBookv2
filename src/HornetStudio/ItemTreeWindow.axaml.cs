...
public partial class ItemTreeWindow : Window
{
    ...
    public ItemTreeWindow(MainWindowViewModel hostViewModel, HornetStudio.Editor.Models.FolderModel folder)
        : this()
    {
        Attach(hostViewModel, folder);
    }

    public void Attach(MainWindowViewModel hostViewModel, HornetStudio.Editor.Models.FolderModel folder)
    {
