...
- Summary file: `AutomationExplorer/docs/widgets/Button.md`
- Help file: `AutomationExplorer/docs/widgets/help/Button.help.md`

## Source

- `UiEditor/Widgets/Button/EditorButtonControl.axaml.cs`
