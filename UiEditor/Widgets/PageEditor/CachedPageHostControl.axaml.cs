...
{
    private readonly Dictionary<PageModel, PageEditorWidget> _pageEditors = [];
    ...
    private void EnsureSelectedPageEditor()
    {
        ...
        var editor = new PageEditorWidget
        {
...
public partial class CachedPageHostWidget : CachedPageHostControl
{
}