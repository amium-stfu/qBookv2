...
public class qPage : BookPage
{
    ...
    private void PublishParameters()
    {
        ...
        if (_setpointAttached is not null)
        {
            UiPublisher.Publish(_setpointAttached);
        }

        if (_tauAttached is not null)
        {
            UiPublisher.Publish(_tauAttached);
        }

        if (_noiseAttached is not null)
        {
            UiPublisher.Publish(_noiseAttached);
        }
    }
