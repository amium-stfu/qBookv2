...
{
    private const string FloatPath = "AllControls/Demo/Float";
    private const string TextPath = "AllControls/Demo/Text";
    private const string BoolPath = "AllControls/Demo/Bool";
    private const string BitsPath = "AllControls/Demo/Bits";
    ...
    {
        HostRegistries.Data.UpdateValue(FloatPath, _floatSource.Value);
        HostRegistries.Data.UpdateValue(TextPath, _textSource.Value);
        HostRegistries.Data.UpdateValue(BoolPath, _boolSource.Value);
        HostRegistries.Data.UpdateValue(BitsPath, _bitsSource.Value);
    }
